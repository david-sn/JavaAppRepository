...
frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         ...
         public void addWidgets()

            {
                    ...
                    JButton DeleteContact = new JButton("DeleteContact");
    	 ...
    	 public void actionPerformed(ActionEvent ae)
    	    {
    	        if(ae.getActionCommand() == "Add New Contact")
    	            ...
    	            {
    	                  JOptionPane.showMessageDialog(frame, "AboutAddressBook:Created By Rahul ChouhanComputer Engg, IET-DAVV,Indore.Website:http://www.Rahul Chouhan.tk","About Address Book",JOptionPane.INFORMATION_MESSAGE);
