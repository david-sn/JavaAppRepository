 ...
 * Download Manager
 *
 * Auther: Sagar Nangare
 * Email:  sag_with_comp@yahoo.co.in
 *
 * Save-Listing1 as>Download.java, Listing 2 as>DownloadManager.java,
   Listing 3 as>DownloadsTableModel.java,Listing 4
as>ProgressRenderer.java.
   Then Compile like>javac DownloadManager.java 
DownloadsTableModel.java
    ProgressRenderer.java Download.java & then
  ...
  implements Observer
{
  ...
  public DownloadManager()
  {
    ...
    table.setDefaultRenderer(JProgressBar.class, (TableCellRenderer) renderer);
